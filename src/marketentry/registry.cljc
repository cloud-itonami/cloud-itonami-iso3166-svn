(ns marketentry.registry
  ...
  call to any real procurement portal (e-JN). It builds the RECORD an
...
(defn register-draft
  ...
  market-entry operator's own act of preparing an e-JN registration
...
(defn register-submit
  ...
  market-entry operator's own act of actually submitting a real e-JN
